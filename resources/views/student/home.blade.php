...
@endif
@if(Session::has('fail'))
<div class="alert alert-danger p-2 text-center"><i class="bi bi-exclamation-octagon me-1 mx-2"></i>{{Session::get('fail')}}</div>
@endif
<div class="pagetitle">
    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          @endif
          <h2 class="text-capitalize">{{ $data->fname }} {{ $data->lname }}</h2>
          <h3>Student</h3>
        </div>
      </div>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">+255 {{ $logged_in_student->phone}}</div>
              </div>
              ...
              <div class="row">
               ...
               <div class="row">
                ...
                <div class="col-lg-9 col-md-8 text-capitalize">{{ $logged_in_student->level}}</div>
              </div>
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                  ...
                  @endif
                  <div class="pt-2">
                    <form class="" action="{{ route('StudentuploadPhoto')}}" method="post" enctype="multipart/form-data">
                      @csrf
            ...
            <div class="tab-pane fade pt-3" id="profile-change-password">
              ...
              <form action ="{{route('UpchangePassword')}}" method='post'>
                @csrf
                <div class="row mb-3">
